...
const cards = [
  {
    icon: <FaSchool />,
   title: 'Ziauddin University and Examination Board',
  subtitle: "I'm studying Intermediate in Computer Science",
  ...
  return (
    ...
    >
      ...
      <motion.p
        ...
        variants={itemVariants}
      >
      I am Tayyab Zaman, a passionate Frontend and MERN Stack Developer currently exploring Full Stack Development, Next.js, and AI-powered web applications. I enjoy building modern, responsive, and scalable websites using technologies like React, Next.js, JavaScript, Tailwind CSS, Firebase, and TypeScript. I am also interested in SaaS products and continuously learning new technologies to improve my development skills. My goal is to create impactful digital experiences and grow as a professional software developer.
      </motion.p>

      <motion.div
        className="grid grid-cols-1 sm:grid-cols-2 gap-10 w-full max-w-3xl"
        variants={itemVariants}
      >
        {cards.map((card, idx) => (
          <motion.div
